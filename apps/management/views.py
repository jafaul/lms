...
# what is difference between cache and cookie

# @login_required -- func based
class CourseListView(PermissionRequiredMixin, LoginRequiredMixin, ListView):
    model = models.Course
    login_url = '/custom-login/'  # Override LOGIN_URL
